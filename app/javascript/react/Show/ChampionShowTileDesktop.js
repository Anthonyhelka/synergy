    ...
    return (
      <div>
        <Responsive minWidth={1024}>
          <Segment id='page-container-desktop'>
            <Segment id='search-container-desktop'>
              <ChampionSearch />
            </Segment>

            <Segment id='champion-container-desktop' basic>
              <Segment id='champion-header-desktop'>
                <Popup on='click' key='cost' position='top center' hideOnScroll={true} trigger={<Label id='champion-header-tier-desktop' className={`tier-${this.props.champion.cost}`} attached='top left'>{this.props.champion.cost}</Label>}>Cost</Popup>
...
//         <Popup on='click' key='cost' position='top center' hideOnScroll={true} trigger={<Label id='champion-header-tier' className={`tier-${this.props.champion.cost}`} attached='top left'>{this.props.champion.cost}</Label>}>Cost</Popup>
//           <div id='champion-header-title'><span>{this.props.champion.name}</span><p>{this.props.champion.title}</p></div>
//           <Image id='champion-header-image' src={`${pathToBanner(`./${this.props.champion.key}`, true)}`} />
//           <div id='champion-header-synergies-container'>
//             {synergiesIconList}
//           </div>
//         </Segment>
//     <Grid.Row id='champion-row-two-desktop'>
