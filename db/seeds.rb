...
demon = Team.create(
  ...
  icon: "./demon",
  teamType: "Origin",
  description: "Attacks from Demons have a chance to burn 20 mana from their target and return mana to the attacker.",
  upgrade_1_number: "2:",
...
brawler = Team.create(
  ...
  upgrade_3_number: "6:",
  upgrade_3_description: "+1000 maximum health"
)
